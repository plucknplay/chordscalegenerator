...
public class RemoveChordAction extends AbstractRemoveAction {

	private static final String ACTION_ID = "com.plucknplay.csg.ui.actions.removeChordAction"; //$NON-NLS-1$

	public RemoveChordAction(final IViewPart view) {
		super(view);
	}
