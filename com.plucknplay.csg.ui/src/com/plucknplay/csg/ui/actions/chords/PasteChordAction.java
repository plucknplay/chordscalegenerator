...
public class PasteChordAction extends AbstractPasteAction {

	private static final String ACTION_ID = "com.plucknplay.csg.ui.actions.pasteChordAction"; //$NON-NLS-1$

	public PasteChordAction(final IViewPart view) {
		super(view);
	}
