...
!define BIT_VERSION win32.win32.x86
!define JAVA_FILE jre-windows-i586.exe
!define OUTPUT_FILE CSG-windows.exe
...
#Function MyFuncDir
##   ${If} ${AtLeastWinVista} - evtl. sollte dieser Hinweis entfernt werden oder noch für Windows 7 ergänzt werden.s
#    ${If} ${IsWinVista}
